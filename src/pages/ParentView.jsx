                            ...
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                onClick={() => setVideoModal({
                                  url: `${API_BASE_URL}/classes/video/${cls.id}`,
                                  title: `Lesson ${cls.date || ''} 录播回放`
                                })}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-lg shadow-sm cursor-pointer"
                              >
                                ▶️ 播放录播视频
                              </button>
                              <a
