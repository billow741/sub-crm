...
return c.json(success({
  ...
  fb_score_phonics: cls.fb_score_phonics ?? null,
  fb_score_vocab: cls.fb_score_vocab ?? null,
  fb_score_speaking: cls.fb_score_speaking ?? null,
  fb_score_listening: cls.fb_score_listening ?? null,
  fb_score_engagement: cls.fb_score_engagement ?? null,
...
classes.patch('/:id', validateParams(idParamSchema), validate(classUpdateSchema), async (c) => {
  ...
  try {
    ...
    return c.json(success({
      ...
      fb_score_phonics: updated.fb_score_phonics ?? null,
      fb_score_vocab: updated.fb_score_vocab ?? null,
      fb_score_speaking: updated.fb_score_speaking ?? null,
      fb_score_listening: updated.fb_score_listening ?? null,
      fb_score_engagement: updated.fb_score_engagement ?? null,
